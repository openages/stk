...
export type DebugLogger<EventData, Name extends keyof EventData> = (type: string, debugName: string, eventName?: Name | EventName, eventData?: EventData[Name] | string) => void;
